...
def go(args):
    ...
    # To succes the test proper boundaries
    ...
    logger.info("Uploading preprocessed data")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_description", 
        type=str,
        help="Download from W&B the raw dataset and apply some basic data cleaning, exporting the result to a new artifact",
        required=True
    )
